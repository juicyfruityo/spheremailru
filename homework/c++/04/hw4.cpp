 ...
 public:
  ...
  BigInt operator+(const BigInt& other) const {
    ...
    BigInt operator-(const BigInt& other) const {
      ...
      // std::cout << tmp.number[max_len-1-min_len] << '\n';
      // if (tmp.number[max_len-min_len-1] == -1) {
      //     tmp.number[max_len-min_len-1] = 9;
      //     tmp.number[max_len-min_len-2] = -1;
      // }
      for (int i=min_len; i < max_len; ++i) {
